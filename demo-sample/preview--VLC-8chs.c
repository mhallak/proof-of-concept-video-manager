...
*   8 channel previews from Sensoray Model 812, using VLC, and in one program.  *
...
int main ()
{
  ...
  if (child_pid != 0) {
	...
	// Preview all 8 video channels, using VLC:
    system ("vlc v4l2:///dev/video0 &");
    printf ("launched: vlc v4l2:///dev/video0 & \n");
    system ("vlc v4l2:///dev/video1 &");
