...
MODULE_DESCRIPTION("v4l2 driver module for Sensoray 812/1012[vbuf2]. Version 1.1.17");
MODULE_AUTHOR("Simon Xu 2011-2014 @intersil. Updates/fixes by Sensoray 2011-2018");
MODULE_LICENSE("GPL");
...
//	m_nVideoFormat = VIDEO_FORMAT_RGB565;
	...
	*/
	...
	//dev->v4l2_dev.release = TW68_dev_release;
			...
			const struct pci_device_id *pci_id)
{
...
#endif
	printk(KERN_INFO "812/1012[vbuf2] driver 08/11/2017 1.1.15\n");
	...
	dev->audio_channels = kcalloc(8, sizeof(*dev->audio_channels), GFP_KERNEL);
