...
1.1.16
video status added to ENUM_INPUT function
driver.py program added as optional check for built-in kernel driver

1.1.15
makefile fixes and option to force video standard to NTSC or PAL without
autodetect
...
1.1.13
build for 3.10 fixed, tested on 3.10
...
"make install" --- manually install the driver.
"make load"    --- manually load the driver.
